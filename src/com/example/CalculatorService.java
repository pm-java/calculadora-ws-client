 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://example.com/", wsdlLocation = "http://calculator-webservice.mybluemix.net/calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://example.com/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://calculator-webservice.mybluemix.net/calculator?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://example.com/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://example.com/", "CalculatorPort"), Calculator.class, features);
    }
